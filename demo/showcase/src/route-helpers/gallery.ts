...
function renderGalleryPageChildren(data: GalleryPageData) {
  ...
  switch (data.pageType) {
    ...
    case "post-detail":
      return [
        ...
        renderReaderPulse(data as GalleryPostData),
...
export function renderGalleryPage(data: GalleryPageData) {
  return renderShowcaseFrame({
    ...
    children: renderGalleryPageChildren(data),
  });
}

export function renderGalleryPageBody(data: GalleryPageData) {
  return main({ class: "showcase-main" }, ...renderGalleryPageChildren(data));
}
...
export function renderGalleryChunkedPage(data: GalleryPageData) {
  ...
  return renderGalleryPageBody(data);
}
