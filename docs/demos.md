...
- `demo/ssg-site`: focused reference for static generation from route entries discovered under `src/routes`, then exported as static files for generic web servers
