...
export const showcaseModes = [
  {
    ...
    proves: "Shows server-first rendering with app handoff for the same post detail view.",
  ...
  },
  {
    ...
    proves: "Shows route-driven loading without needing SSR HTML as the starting point.",
  ...
  },
  {
    ...
    proves: "Shows app-owned resolution and component interactions for the blog detail page.",
  ...
  },
  {
    ...
    proves: "Shows that the same content model can be emitted as prebuilt blog pages.",
  ...
  },
  {
    id: "adaptive",
    title: "Adaptive",
    summary: "Swap between replace and stack presentation for the same reading flow.",
    proves: "Shows how navigation presentation changes the reader experience without changing content.",
